...
EN EL MAUSOLEO DEL ICAP DEBE DE APORTES BS 5.550.- HASTA SU FALLECIMIENTO',
      ...
      [
        'affiliate_id' => '193',
        'date' => '2025-11-21',
        'description' => 'FALLECIO, ESTA EN EL MAUSOLEO DEL ICAP 
Y ES EXENTO DESDE NOVIEMBRE DE 2022. SEGÚN RESOLUCIÓN
002/2022  NO TIENE CUENTAS PENDIENTES CON EL ICAP',
        'mausoleum' => 'SI',
      ],
      [
        'affiliate_id' => '286',
        'date' => '2026-02-07',
        'description' => 'FALLECIO, SE LE OTORGO EL MAUSOLEO DEL ICAP Y  CANCELO TODOS SUS APORTES LA FECHA DE SU FALLECIMIENTO, HASTA EL MES DE SU DECESO. (02/2026) Bs.5.100 NO TIENE CUENTAS PENDIENTES CON EL ICAP',
        'mausoleum' => 'SI',
      ],
      [
        'affiliate_id' => '2454',
        'date' => '2026-03-04',
        'description' => 'FALLECIO, SE LE OTORGO EL MAUSOLEO DEL 
ICAP Y TIENE CANCELADO TODOS SUS APORTES HASTA LA FECHA DE SU FALLECIMIENTO. (02/2026)
NO TIENE CUENTAS PENDIENTES CON EL ICAP',
        'mausoleum' => 'SI',
      ],
    ];
