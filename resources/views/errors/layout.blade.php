...
<head>
    ...
    <title>{{ __('Error') }} @yield('code') - {{ config('app.name') }}</title>
...
<body>
    <div class="container">
        ...
        <h2 class="title">@yield('title', '¡Oops! Algo salió mal')</h2>

        <p class="message">
            @yield('message', 'Hemos encontrado un problema inesperado. Nuestro equipo ya está trabajando en solucionarlo.')
        </p>
        ...
        <footer>
            &copy; {{ date('Y') }} {{ config('app.name') }} — Si el problema persiste, contáctanos.
        </footer>
    </div>
</body>
