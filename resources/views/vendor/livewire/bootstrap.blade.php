        ...
        <nav class="d-flex justify-items-center justify-content-end">
            <div class="d-flex justify-content-end flex-fill d-sm-none">
                <ul class="pagination">
                    ...
                    @else
                        <li class="page-item">
                            <button type="button" dusk="previousPage{{ $paginator->getPageName() == 'page' ? '' : '.' . $paginator->getPageName() }}" class="page-link" wire:click="previousPage('{{ $paginator->getPageName() }}')" x-on:click="{{ $scrollIntoViewJsSnippet }}" wire:loading.attr="disabled" > &laquo;/* @lang('pagination.previous') */</button>
                        </li>
                    @endif
                    ...
                    @if ($paginator->hasMorePages())
                        <li class="page-item">
                            <button type="button" dusk="nextPage{{ $paginator->getPageName() == 'page' ? '' : '.' . $paginator->getPageName() }}" class="page-link" wire:click="nextPage('{{ $paginator->getPageName() }}')" x-on:click="{{ $scrollIntoViewJsSnippet }}" wire:loading.attr="disabled" > &raquo;/* @lang('pagination.next') */</button>
                        </li>
                    @else
                        <li class="page-item disabled" aria-disabled="true">
                            <span class="page-link" aria-hidden="true">&raquo;/* @lang('pagination.next') */</span>
                        </li>
                    @endif
                </ul>
            </div>
