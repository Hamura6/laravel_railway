...
<?php $component->withAttributes([]); ?>
             ...
             <?php $__env->endSlot(); ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Crear eventos')): ?>
                    ...
                    <div class="custom-card">
                        <div class="custom-imgbox">
                            <img class="custom-img"
                                src="<?php echo e(asset('storage/event_photos/' . ($event->firstPhoto->name.'.webp' ?? '69194dd33f84e.png'))); ?>"
                                alt="">
                            <div
                        ...
                        <div class="custom-details px-2 pt-2">
                            ...
                            <div class="custom-footer d-flex gap-1">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Eliminar eventos')): ?>
...
<?php /**PATH /var/www/icapProject/resources/views/livewire/events-photo/event-component.blade.php ENDPATH**/ ?>