...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['title' => 'Descuento']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Descuento']); ?>
    <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?> " wire:model="start_date"
...
unset($__errorArgs, $__bag); ?> " wire:model="end_date"
                id="floatingInput" placeholder="name@example.com">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $fees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="col-md-6">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" wire:model="selectedFees" value="<?php echo e($fee->id); ?>"
                    id="fee_<?php echo e($fee->id); ?>">
    ...
    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedFees'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/icapProject/resources/views/livewire/discounts/form.blade.php ENDPATH**/ ?>