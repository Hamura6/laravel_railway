...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card-header','data' => ['title' => 'Gestión de Directorio']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Gestión de Directorio']); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $directories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $directory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="align-middle">
                        ...
                        <td class="text-secondary">
                            <?php echo e($directory->label); ?>

                        </td>
                        <td class="text-center">
                            <?php echo e($directory->level); ?>
...
<?php endif; ?>
    <?php echo $__env->make('livewire.direcories.form_create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<?php /**PATH /var/www/icapProject/resources/views/livewire/direcories/directory-form-component.blade.php ENDPATH**/ ?>