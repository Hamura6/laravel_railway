...
<head>
    ...
    <title><?php echo e($institution->initials); ?> | Ilustre Colegio de Abogados de Potosí</title>
...
abogados Potosí, abogados Bolivia, abogacía Potosí, ilustre colegio abogados">
    ...
    <meta property="og:image" content="<?php echo e(asset('apple-touch-icon.png')); ?>">
    ...
    <meta name="twitter:description"
        content="El Ilustre Colegio de Abogados de Potosí (ICAP) agremia y regula el ejercicio de la abogacía en Potosí, Bolivia.">
    <meta name="twitter:image" content="<?php echo e(asset('apple-touch-icon.png')); ?>">
...
<?php /**PATH /var/www/icapProject/resources/views/site/layout.blade.php ENDPATH**/ ?>