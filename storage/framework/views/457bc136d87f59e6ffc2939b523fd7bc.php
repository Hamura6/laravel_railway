...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card-header','data' => ['title' => 'Control de Denuncias','name' => 'Denuncia']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Control de Denuncias','name' => 'Denuncia']); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <div class="col-md-12 d-grid gap-1 d-md-flex justify-content-md-end">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Crear denuncias')): ?>
...
<?php $component->withAttributes([]); ?>
                    ...
                    <div class="card-footer bg-transparent border-0 d-flex justify-content-center d-grid gap-1">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Editar denuncias')): ?>
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Eliminar denuncias')): ?>
                            <button type="button" wire:target="changeStatus, delete, edit" wire:loading.attr="disabled"
...
<?php /**PATH /var/www/icapProject/resources/views/livewire/demands/demands-details.blade.php ENDPATH**/ ?>