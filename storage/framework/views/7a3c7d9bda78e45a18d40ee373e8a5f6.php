            ...
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $affiliates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $affiliate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="align-middle">
                    ...
                    <td class="text-secondary" align="center">
                        <!--[if BLOCK]><![endif]--><?php if( $affiliate->ultimoPago> now()): ?>
                    ...
                    <td class="text-secondary" align="center"><?php echo e(number_format($affiliate->aportes, 2)); ?> Bs. <br>
                        Cant.   <?php echo e($affiliate->aportes_cant); ?></td>
                    <td class="text-secondary" align="center"><?php echo e($affiliate->prest - $affiliate->planes); ?>
