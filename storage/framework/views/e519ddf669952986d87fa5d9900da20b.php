...
<head>
    ...
    <title><?php echo e($institution->initials ?? config('app.name')); ?></title>
...
<?php endif; ?>
                <div class="card border m-0  border-dark h-80">
                    <div class="card-body p-2">
                        <form action="<?php echo e(route('save')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="d-flex justify-content-end gap-2 pt-4">
                                <a href="<?php echo e(route('institution.configuration')); ?>" class="btn btn-sm btn-secondary "> <i
                                        class='fas fa-ban '></i> Cancelar</a>
                                <button type="submit" class="btn btn-sm btn-dark"> <i class="fas  fa-save "></i>
                                    Guardar</button>
...
<?php /**PATH /var/www/icapProject/resources/views/prueba/requirement.blade.php ENDPATH**/ ?>