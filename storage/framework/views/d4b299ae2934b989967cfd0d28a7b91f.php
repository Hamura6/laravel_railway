            ...
            <ul class="pagination">
                ...
                <?php else: ?>
                    <!--[if BLOCK]><![endif]--><?php if(method_exists($paginator,'getCursorName')): ?>
                        <li class="page-item">
                            <button dusk="previousPage" type="button" class="page-link" wire:key="cursor-<?php echo e($paginator->getCursorName()); ?>-<?php echo e($paginator->previousCursor()->encode()); ?>" wire:click="setPage('<?php echo e($paginator->previousCursor()->encode()); ?>','<?php echo e($paginator->getCursorName()); ?>')" x-on:click="<?php echo e($scrollIntoViewJsSnippet); ?>" wire:loading.attr="disabled" > &laquo; </button>
                        </li>
                    <?php else: ?>
                        <li class="page-item">
                ...
                <!--[if BLOCK]><![endif]--><?php if($paginator->hasMorePages()): ?>
                    <!--[if BLOCK]><![endif]--><?php if(method_exists($paginator,'getCursorName')): ?>
                        <li class="page-item">
                            <button dusk="nextPage" type="button" class="page-link" wire:key="cursor-<?php echo e($paginator->getCursorName()); ?>-<?php echo e($paginator->nextCursor()->encode()); ?>" wire:click="setPage('<?php echo e($paginator->nextCursor()->encode()); ?>','<?php echo e($paginator->getCursorName()); ?>')" x-on:click="<?php echo e($scrollIntoViewJsSnippet); ?>" wire:loading.attr="disabled" >&raquo;</button>
                        </li>
                    <?php else: ?>
                        <li class="page-item">
...
<?php /**PATH /var/www/icapProject/resources/views/vendor/livewire/simple-bootstrap.blade.php ENDPATH**/ ?>