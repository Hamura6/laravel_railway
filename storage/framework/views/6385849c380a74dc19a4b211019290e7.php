...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('header', null, []); ?> 
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Crear descuentos')): ?>
                ...
                <div class="col-md-4">
                    <div class="card shadow  h-100 border-<?php echo e($discount->is_active ? 'success' : 'secondary'); ?> ">
                        ...
                        <div class=" card-footer py-1 d-flex gap-1 justify-content-end">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Editar descuentos')): ?>
...
<?php endif; ?>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Eliminar descuentos')): ?>
...
<?php /**PATH /var/www/icapProject/resources/views/livewire/discounts/discount-component.blade.php ENDPATH**/ ?>