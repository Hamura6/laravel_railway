<?php $__env->startSection('content'); ?>
    <div class="banner">
        <img class="img-banner" src="<?php echo e(asset('images/single.jpg')); ?>" alt="Cursos">
        ...
        <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
                <div class="polaroid-card" data-bs-toggle="tooltip" title="<?php echo e($photo->title ?? ''); ?>">
                    <div class="polaroid">
                        <div class="photo">
                            <a href="<?php echo e($photo->image); ?>" target="_blank" class="news-img-wrapper d-block">
                            <img src="<?php echo e($photo->image); ?>" class="w-100 h-100 object-fit-cover" alt="Imagen" loading="lazy">
                            </a>
