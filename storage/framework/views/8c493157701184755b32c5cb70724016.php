<?php $__env->startSection('content'); ?>
    <div class="banner">
        <img class="img-banner" src="<?php echo e(asset('image/single.jpg')); ?>" alt="Cursos">
                    ...
                    <a href="<?php echo e(route('site.events.galery', $event->id)); ?>">
                        <div class="timeline-item" data-id="112">
                            ...
                            <div class="timeline-content shadow-lg">
                                ...
                                <img src="<?php echo e(asset('storage/event_photos/' . $event->firstPhoto->name)); ?>.webp" alt="1212sd"
...
<?php echo $__env->make('site.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/icapProject/resources/views/site/pages/events.blade.php ENDPATH**/ ?>