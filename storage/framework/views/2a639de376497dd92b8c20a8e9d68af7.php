  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption">
        ...
        <a href="<?php echo e(route('site.about')); ?>" class="btn btn-outline-warning btn-lg mt-3 px-4">Ver más</a>
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption">
        ...
        <a href="<?php echo e(route('site.requirement')); ?>" class="btn btn-warning btn-lg mt-3 px-4 shadow">Participa con nosotros</a>
      </div>
    </div>
  </div>
  ...
  <div class="carousel-indicators">
    ...
    <div class="col-derecha py-5 px-3 px-lg-4">
        <div class="row g-3 g-xl-3">
            ...
            <!-- SEMINARIOS -->
            <div class="col-12 col-md-6 col-lg-6">
                <a href="<?php echo e(route('site.news')); ?>" class="resource-card d-block h-100 text-decoration-none">
...
<?php echo $__env->make('site.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/icapProject/resources/views/site/pages/index.blade.php ENDPATH**/ ?>