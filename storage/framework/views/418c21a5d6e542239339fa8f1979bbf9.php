    ...
    <section class="section section-color-1">
      <div class="section-container">
        <div class="section-header">
          ...
          <p class="section-subtitle"><?php echo e($institution->mission); ?> </p>
        </div>
      </div>
    </section>
    ...
    <section class="section section-color-2">
      <div class="section-container">
        <div class="section-header">
          ...
          <p class="section-subtitle"><?php echo e($institution->vision); ?></p>
        </div>
      </div>
    </section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('site.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/icapProject/resources/views/site/pages/about.blade.php ENDPATH**/ ?>