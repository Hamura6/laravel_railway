...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card-header','data' => ['title' => 'Condecoración','name' => 'Pagos']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Condecoración','name' => 'Pagos']); ?>
                ...
                <table class="table  table-bordered border-light table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($affiliatesConfirm->count()); ?></td>
