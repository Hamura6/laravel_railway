...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card-header','data' => ['title' => ''.e($this->id <= 0 ? 'Crear' : 'Actualizar').' | Artículo','name' => 'articulo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($this->id <= 0 ? 'Crear' : 'Actualizar').' | Artículo','name' => 'articulo']); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="d-grid gap-1 d-md-flex justify-content-md-end">
                    <a href="<?php echo e(route('articles')); ?>" wire:target="add,update,store"
...
<?php /**PATH /var/www/icapProject/resources/views/livewire/articles/form-article.blade.php ENDPATH**/ ?>