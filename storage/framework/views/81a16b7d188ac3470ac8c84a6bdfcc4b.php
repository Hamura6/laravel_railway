...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card-header','data' => ['title' => ''.e($this->id <= 0 ? 'Crear' : 'Actualizar').' | Noticia','name' => 'noticia']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($this->id <= 0 ? 'Crear' : 'Actualizar').' | Noticia','name' => 'noticia']); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input
                                    class="form-control form-control-sm <?php $__errorArgs = ['file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="d-grid gap-1 d-md-flex justify-content-md-end">
                    <a href="<?php echo e(route('news')); ?>" wire:target="add,update,store"
...
<?php /**PATH D:\ICAPV4\ICAP\resources\views/livewire/news/form-new.blade.php ENDPATH**/ ?>